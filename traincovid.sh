...
TRAIN_DATA_LIST="covid"
POS_DIR="outputs"
NEG_DIR="outputs"
DATA_DIR="dataset"
INBATCH_PKL_PATH_DIR="outputs/inbatch/covid_train_inbatch.pkl"
FEATURE_PKL_PATH_DIR="outputs/features/covid_train_features.pkl"
BATCH_SIZE=16
GRAD_ACCUM=4
NEG_K=8
NUM_HEADS=4
...
GAMMA=0.15
ETA=0.02
TEMPERATURE_IN_BATCH=0.15
TEMPERATURE_HARDNEG=0.20
TEMPERATURE_TEACHER_HARDNEG=1.0
SCALE_PARAM=0.8
LOG_INTERVAL=10
EVAL_INTERVAL=200
...
OUTPUT_DIR="PATH_TO_OUTPUT_MODEL/covid"
WEIGHT_DECAY=0.1
MAX_GRAD_NORM=1.0
INBATCH_MARGIN=0.15
