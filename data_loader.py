...
def load_text_dataset(name, pos_dir, neg_dir, file_path, neg_K, res_data, split):
    ...
    print(f"  Positive pickle file: {pos_dir}")
    print(f"  Negative pickle file: {neg_dir}")
    print(f"  Data file (TSV/JSONL): {file_path}\n")
    ...
    if split == 'train' and missing_hard_neg_count > 0:
        print(f"Total queries with NO hard negatives: {missing_hard_neg_count}")
