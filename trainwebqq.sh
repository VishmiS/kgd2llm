...
NEG_DIR="outputs"
DATA_DIR="dataset"
INBATCH_PKL_PATH_DIR="outputs/inbatch/webq_train_inbatch.pkl"
FEATURE_PKL_PATH_DIR="outputs/features/webq_train_features.pkl"
BATCH_SIZE=16
GRAD_ACCUM=4
NEG_K=5
NUM_HEADS=4
...
OUTPUT_DIR="PATH_TO_OUTPUT_MODEL/webq"
WEIGHT_DECAY=0.1
MAX_GRAD_NORM=1.0
INBATCH_MARGIN=0.15
