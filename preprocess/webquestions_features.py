...
def webquestions_template_context(query, passage):
    return (
    ...
    for i, query in enumerate(total_keys):
        if shard_size * id_shard <= i < shard_size * (id_shard + 1):
            ...
            if task_type == "context":
                qry_doc_list = [webquestions_template_context(query, d) for d in doc_list]
            else:
...
if __name__ == "__main__":
    ...
    FINETUNED_MODEL_PATH = "./distilbert-webq-classifier-final"
    ...
    generated_logits, features_dict, inbatch_dict, counters = generate_features_and_inbatch(
        neg_pkl_file="../outputs/neg_web_questions/train/query_hard_negatives.pkl",
        task_type=task_type,
        bs=batch_size,
    ...
    write_pickle(generated_logits, "../outputs/logits/webq_train_neg_logits.pkl")
    print("Saved train logits to ../outputs/logits/webq_train_neg_logits.pkl")

    write_pickle(features_dict, "../outputs/features/webq_train_features.pkl")
    print("Saved train features to ../outputs/features/webq_train_features.pkl")

    write_pickle(inbatch_dict, "../outputs/inbatch/webq_train_inbatch.pkl")
    print("Saved train in-batch similarities to ../outputs/inbatch/webq_train_inbatch.pkl")
    ...
    generated_logits, features_dict, inbatch_dict, counters = generate_features_and_inbatch(
        neg_pkl_file="../outputs/neg_web_questions/val/query_hard_negatives.pkl",
        task_type=task_type,
        bs=batch_size,
        teacher_max_seq_length=teacher_max_seq_length,
        num_shards=num_shards,
    ...
    write_pickle(generated_logits, "../outputs/logits/webq_val_neg_logits.pkl")
    print("Saved val logits to ../outputs/logits/webq_val_neg_logits.pkl")

    write_pickle(features_dict, "../outputs/features/webq_val_features.pkl")
    print("Saved val features to ../outputs/features/webq_val_features.pkl")

    write_pickle(inbatch_dict, "../outputs/inbatch/webq_val_inbatch.pkl")
    print("Saved val in-batch similarities to ../outputs/inbatch/webq_val_inbatch.pkl")
