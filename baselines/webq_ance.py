...
# python /root/pycharm_semanticsearch/baselines/webq_ance.py
...
class ANCEEvaluator:
    ...
    def evaluate(self, k=10):
        """
        Evaluate ANCE on MRR@k and Recall@k
...
def main():
    ...
    try:
        ...
        # Initialize ANCE evaluator
        print("Initializing ANCE...")
        evaluator = ANCEEvaluator(corpus, queries, qrels)

        # Evaluate
        print("Evaluating ANCE...")
